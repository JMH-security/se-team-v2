// app/seteam/admin/wt/tier3s/page.tsx
"use client";
...
export default function Tier3sPage() {
	const { tier3s, deleteTier3 } = useTier3();
	...
	return (
		<div className="container mx-auto text-center p-4 m-4 max-w-[800px]">
			...
			<div className="bg-primary/10 rounded-2xl px-4">
				...
				{editingId === null && (
					<Tier3Form onSuccess={() => setEditingId(null)} />
				)}
				{editingId && (
					<div className="mt-4">
						<h2>Edit Tier 1 Option</h2>
						<Tier3Form
							tier3={tier3s.find((r) => r._id === editingId)}
