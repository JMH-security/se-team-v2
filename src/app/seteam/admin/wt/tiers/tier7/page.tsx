// app/seteam/admin/wt/tier7s/page.tsx
"use client";

import { useTier7 } from "@/contexts/tiers/Tier7Context";
import Tier7Form from "@/components/wt/tiers/Tier7Form";
...
export default function Tier7sPage() {
	const { tier7s, deleteTier7 } = useTier7();
	...
	return (
		<div className="container mx-auto text-center p-4 m-4 max-w-[800px]">
			...
			<div className="bg-primary/10 rounded-2xl px-4">
				{editingId === null && (
					<h1 className="text-2xl font-bold mb-4">Add Tier 7 Options</h1>
				)}
				{editingId && (
					<h1 className="text-2xl font-bold mb-4">Edit Tier Value</h1>
				)}
				{editingId === null && (
					<Tier7Form onSuccess={() => setEditingId(null)} />
				)}
				{editingId && (
					<div className="mt-4">
						<h2>Edit Tier 6 Options</h2>
						<Tier7Form
							tier7={tier7s.find((r) => r._id === editingId)}
