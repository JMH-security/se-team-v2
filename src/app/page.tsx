  ...
  return (
    ...
    <div className="grid items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      ...
      <ModeToggle />
        <div className="flex flex-wrap justify-center">
          <div className="flex flex-wrap justify-center items-center mb-18">
                  <h1 className="text-2xl font-bold justify-center">Welcome Team</h1>
              </div>
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        <div className="flex flex-wrap items-center justify-center">
          <div className="m-4"><h1>Responsive.</h1></div>
          <div className="m-4"><h1>Committed.</h1></div>
          <div className="m-4"><h1>Innovative.</h1></div>
        </div>
      </footer>
    </div>
    </>
