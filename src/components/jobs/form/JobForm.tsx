...
const jobSchema = yup.object().shape({
    ...
    taxAddress1: yup.string().when("sameAsServiceAddress", { is: false, then: (schema) => schema.required("Tax Street Address is required")}),
    taxAddress2: yup.string(),
    taxCity: yup.string().when("sameAsServiceAddress", { is: false, then: (schema) => schema.required("Tax City is required")}),
    taxState: yup.string().when("sameAsServiceAddress", { is: false, then: (schema) => schema.required("Tax State is required")}),
    taxZip: yup.string().when("sameAsServiceAddress", { is: false, then: (schema) => schema.required("Tax Zip is required")}),
  });
      ...
      <form name="addnewjob" onSubmit={handleSubmit} className="">
        ...
        <div className="">
          ...
          <div className="">
            ...
            {errors.svcdur && <span className={styles.error}>{errors.svcdur}</span>}
          </div>
          <div className="">
            ...
            {errors.taxinsid && (
              <span className="">{errors.taxinsid}</span>
            )}
          </div>
          <div className="">
        ...
        <div className="">
          ...
          <div className="">
            <div className="">
              <label htmlFor="uniformSecurityType">Uniform Security Type</label>
              <select
