				...
				<div className="flex flex-wrap bg-muted m-1 p-2 grow">
					<NavigationMenu>
						<NavigationMenuList className="flex flex-wrap mr-1 ml-1">
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-gp">
									WinTeam Items
								</NavigationMenuTrigger>
								<NavigationMenuContent className="">
									<Link
										className="mt-2"
										href="/seteam/customers"
										legacyBehavior
										passHref
									>
										<NavigationMenuLink
					...
					<NavigationMenu>
						<NavigationMenuList className="flex flex-wrap mr-1 ml-1">
							<NavigationMenuItem>
								...
								<NavigationMenuContent className="">
									<Link href="/seteam/pto" legacyBehavior passHref>
										<NavigationMenuLink
											className={navigationMenuTriggerStyle()}
										>
											Request PTO
							...
							<NavigationMenuList className="mr-1 ml-1">
								<NavigationMenuItem>
									...
									<NavigationMenuContent>
										...
										<Link href="/seteam/admin/pto" legacyBehavior passHref>
											<NavigationMenuLink
												className={navigationMenuTriggerStyle()}
											>
												PTO Approvals
