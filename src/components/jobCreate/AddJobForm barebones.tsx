...
export const AddJobForm = ({ customerId }: { customerId: string }) => {
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Job Tier id</FormLabel>
              <FormControl>
                <Input type="text" placeholder="Job Tier Value" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="number" placeholder="Custom Fields Number" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
