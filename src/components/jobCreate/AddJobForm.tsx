...
export const AddJobForm = (customerObj: Customer) => {
	...
	console.log(
		"Customer.CustomerID AddJobForm:",
		customerObj.customer.CustomerID
	);
	...
	const onSubmit2: SubmitHandler<z.infer<typeof jobFormSchema>> = async (
		data
	) => {
		console.log("Form submitted with data:", data);
	};
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										type="text"
										placeholder="jobPayrollTaxStateId"
										{...field}
									/>
								</FormControl>
								<FormMessage />
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										type="text"
										placeholder="Job Tier Value Description"
										{...field}
									/>
								</FormControl>
								<FormMessage />
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										type="text"
										placeholder="Custom Fields value"
										{...field}
									/>
								</FormControl>
								<FormMessage />
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										type="text"
										placeholder="Time Sheet Type ID"
										{...field}
									/>
								</FormControl>
								<FormMessage />
